...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'qyu(9l9v%^+r(vt#ecf+36#lis516#3bo5@bo-rd*d%a=!%8#!')


# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['InventoryManagement-Django.onrender.com', 'localhost']
